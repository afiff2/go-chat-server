...
type Message struct {
	...
	Uuid       string       `gorm:"column:uuid;uniqueIndex;type:char(36);not null;comment:消息uuid"`
	SessionId  string       `gorm:"column:session_id;index;type:char(36);not null;comment:会话uuid"`
	...
	SendId     string       `gorm:"column:send_id;index;type:char(36);not null;comment:发送者uuid"`
	...
	ReceiveId  string       `gorm:"column:receive_id;index;type:char(36);not null;comment:接受者uuid"`
	...
	FileSize   string       `gorm:"column:file_size;type:char(36);comment:文件大小"`
