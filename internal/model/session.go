...
type Session struct {
	...
	Uuid          string         `gorm:"column:uuid;uniqueIndex;type:char(36);comment:会话uuid"`
	SendId        string         `gorm:"column:send_id;Index;type:char(36);not null;comment:创建会话人id"`
	ReceiveId     string         `gorm:"column:receive_id;Index;type:char(36);not null;comment:接受会话人id"`
