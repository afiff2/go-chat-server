...
type ContactApply struct {
	...
	Uuid        string         `gorm:"column:uuid;uniqueIndex;type:char(36);comment:申请id"`
	UserId      string         `gorm:"column:user_id;index;type:char(36);not null;comment:申请人id"`
	ContactId   string         `gorm:"column:contact_id;index;type:char(36);not null;comment:被申请id"`
