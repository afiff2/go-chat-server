      ...
      <el-container class="chat-window-container">
        <el-header class="header-container">
          <div style="display: flex; align-items: center; flex-direction: row;">
            <svg t="1736782942164" class="header-icon" viewBox="0 0 1024 1024" version="1.1"
              xmlns="http://www.w3.org/2000/svg" p-id="2358" width="200" height="200">
              <path
        ...
        <el-container>
          <el-aside class="manager-aside-container">
            <el-menu unique-opened>
              <el-sub-menu index="1">
                <template #title>
                  <svg t="1736823523206" class="manager-user-icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="1477" width="200" height="200">
                    <path
                ...
                <el-menu-item index="1-1" @click="showDisableUserTable"><svg t="1736825139556" class="menu-item-icon"
                    viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4645" width="200"
                    height="200">
                    <path
                      ...
                      fill="#444444" p-id="4646"></path>
                  </svg>
                  启用/禁用
                </el-menu-item>
                <el-menu-item index="1-2" @click="showDeleteUserTable">
                  <svg t="1736825210236" class="menu-item-icon" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <path
                      ...
                      fill="#333333" p-id="5698"></path>
                  </svg>删除
                </el-menu-item>
                <el-menu-item index="1-3" @click="showSetAdminTable">
                  <svg t="1736825411779" class="menu-item-icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="6703" width="200" height="200">
                    <path
                      ...
                      fill="#444444" p-id="6704"></path>
                  </svg>设置为管理员
                </el-menu-item>
              </el-sub-menu>
              <el-sub-menu index="2">
                <template #title>
                  <svg t="1736823667080" class="manager-group-icon" viewBox="0 0 1143 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="3627" width="200" height="200">
                    <path
                ...
                <el-menu-item index="2-1" @click="showDisableGroupTable">
                  <svg t="1736825139556" class="menu-item-icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="4645" width="200" height="200">
                    <path
                      d="M512 853.333333c-187.733333 0-341.333333-153.6-341.333333-341.333333s153.6-341.333333 341.333333-341.333333 341.333333 153.6 341.333333 341.333333-153.6 341.333333-341.333333 341.333333z m0-85.333333c140.8 0 256-115.2 256-256s-115.2-256-256-256-256 115.2-256 256 115.2 256 256 256zM401.066667 341.333333l273.066666 273.066667-59.733333 59.733333L341.333333 401.066667 401.066667 341.333333z"
                      fill="#444444" p-id="4646"></path>
                  </svg>
                ...
                <el-menu-item index="2-2" @click="showDeleteGroupTable">
                  <svg t="1736825642071" class="menu-item-icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="7972" width="200" height="200">
                    <path
                      d="M960 384h-80V144H144v666.519L231.778 752H448v80H256L64 960V64h896v320z m-704-80h512v80H256v-80z m0 208h192v80H256v-80z"
                      fill="#2c2c2c" p-id="7973"></path>
                    <path
          ...
          <el-main class="manager-main-container">
            <DeleteUserModal :isVisible="currentModal === 'deleteUser'"></DeleteUserModal>
            <DisableUserModal :isVisible="currentModal === 'disableUser'"></DisableUserModal>
            <SetAdminModal :isVisible="currentModal === 'setAdmin'"></SetAdminModal>
            <DeleteGroupModal :isVisible="currentModal === 'deleteGroup'"></DeleteGroupModal>
            <DisableGroupModal :isVisible="currentModal === 'disableGroup'"></DisableGroupModal>
          </el-main>
        </el-container>
      </el-container>
    </div>
...
export default {
  ...
  setup() {
    ...
    const showDisableUserTable = () => {
      data.currentModal = 'disableUser';
    };

    const showDeleteUserTable = () => {
      data.currentModal = 'deleteUser';
    };

    const showSetAdminTable = () => {
      data.currentModal = 'setAdmin';
    };

    const showDeleteGroupTable = () => {
      data.currentModal = 'deleteGroup';
    };

    const showDisableGroupTable = () => {
      data.currentModal = 'disableGroup';
    };
